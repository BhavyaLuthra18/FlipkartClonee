...
const ProductDetail = ({product}) => {
    ...
    const date = new Date(new Date().getTime()+(5*24*60*60*1000)) // 5 days
     ...
     <Typography>{product.title.longTitle}</Typography>
      <Typography style={{marginTop:5, color:'#878787',fontSize:14}}> 
            ...
            <SmallText>
                ...
                <Typography><StyledBadge/>Sign up for Flipkart and get Flipkart GiftCard worth  ₹100* Know More</Typography>
